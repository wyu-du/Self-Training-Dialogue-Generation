...
> [Self-training with Two-phase Self-augmentation for Few-shot Dialogue Generation](https://arxiv.org/abs/2205.09661) <br>
> Wanyu Du, Hanjie Chen and Yangfeng Ji <br>
> Findings of EMNLP 2022

<img src="img/framework.png" alt="framework" width="90%" style="horizontal-align:middle"/><br>
Here are a few data examples generated by our method: <br>
<img src="img/data.png" alt="data" width="80%" style="horizontal-align:middle"/>
