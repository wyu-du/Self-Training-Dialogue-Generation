...
def inference(args):
    output_dir = f"{args.root_models}/{args.model_name}_{args.flag}_{args.dataset}_{args.domain}_{args.train_set}"
...
if __name__ == '__main__':
    ...
    p.add_argument('-t', '--task', type=str, default='decode', help="train/decode/augment/select")
